      ...
      <OperationalWorkspace data-calls-layout="table-first">
        ...
        >
          ...
          >
            ...
            >
              <div className="mb-2 flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                <nav
                  ...
                  data-calls-saved-views="route-filters"
                >
                  <span className="mr-1 text-xs font-medium text-[var(--forge-muted)]">
                    View
                  </span>
                  {quickViews.map((view) => (
                    <Link
            ...
            <div data-calls-primary-table="true">
              <div className="md:hidden">
                <div
                  className="grid gap-2"
                  data-forge-mobile-table-cards="true"
                >
                  {calls.length ? (
                    calls.map((call) => {
                  ...
                  <table className="w-full min-w-[720px] border-collapse">
                    <thead>
                      <tr className="border-b border-[var(--forge-border)] bg-[color-mix(in_srgb,var(--forge-text)_2.4%,transparent)]">
                        ...
                        <th
                          className="w-20 px-4 py-3 text-right text-[0.66rem] font-semibold uppercase tracking-[0.08em] text-[var(--forge-muted)]"
                          scope="col"
                        >
                          Action
                        </th>
                        ...
                        calls.map((call) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="px-4 py-3 text-sm font-medium text-[var(--forge-muted)]">
                                {formatTimestamp(call.createdAt)}
                              </td>
          ...
          >
            {selectedCall ? (
              <dl className="divide-y divide-[var(--forge-border)] text-sm">
                ...
                <div className="flex items-center justify-between gap-3 py-2">
                  <dt className="text-[var(--forge-muted)]">Uploaded</dt>
                  <dd className="text-right font-medium text-[var(--forge-text)]">
...
function buildCallsHref(
  ...
  if (next.minScore !== undefined)
    params.set("minScore", String(next.minScore));
  if (next.maxScore !== undefined)
    params.set("maxScore", String(next.maxScore));
...
function repDisplayName(
  call: Pick<CallSummary, "repFirstName" | "repLastName">,
) {
