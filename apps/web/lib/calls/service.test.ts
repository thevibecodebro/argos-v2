...
import { deleteAnnotation, type CallsRepository } from "./service";
...
describe("deleteAnnotation", () => {
  it("allows the annotation author to delete their own note", async () => {
    ...
    const result = await deleteAnnotation(repository, "rep-1", "call-1", "annotation-1");
  ...
  it("allows managers to delete another user's annotation", async () => {
    ...
    const result = await deleteAnnotation(repository, "manager-1", "call-1", "annotation-1");
  ...
  it("blocks a non-manager from deleting someone else's annotation", async () => {
    ...
    const result = await deleteAnnotation(repository, "rep-2", "call-1", "annotation-1");
