...
export function workspaceThemeToForgeVars(theme: WorkspaceTheme) {
  ...
  return {
    ...
    "--forge-table-bg": colors.surface,
    "--forge-table-header-bg": colors.surfaceRaised,
    "--forge-item-bg": colors.surfaceRaised,
    "--forge-item-selected-bg": navigation.leftActiveBackground,
    "--forge-control-bg": colors.surfaceRaised,
    "--forge-transcript-bg": colors.surface,
    "--forge-bubble-bg": colors.surfaceRaised,
    "--forge-floating-bg": colors.surface,
