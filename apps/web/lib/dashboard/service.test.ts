  ...
  it("builds org skill averages, call volume, training stats, and rep skill matrix", async () => {
    ...
    expect(result).toEqual({
      skillAverages: [
        ...
        { category: "In-Depth Discovery", avgScore: 78 },
        { category: "Transition to Pitch", avgScore: 64 },
        { category: "Pitch/Demo", avgScore: 79 },
        { category: "Overcome Objections", avgScore: 71 },
