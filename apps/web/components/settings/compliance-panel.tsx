        ...
        {hasConsented ? (
          <div className="mt-5 rounded-[1.2rem] border border-emerald-500/25 bg-emerald-500/10 px-4 py-4">
            <div className="flex items-start gap-3">
              <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full border border-emerald-500/40 bg-emerald-500/20 text-xs text-emerald-300">
                ✓
              </span>
              <div>
          ...
          <div className="mt-5 rounded-[1.2rem] border border-amber-500/20 bg-amber-500/5 px-4 py-4">
            <div className="flex items-start gap-3">
              <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full border border-amber-500/40 bg-amber-500/15 text-xs font-bold text-amber-300">
                !
              </span>
              <div>
        ...
        <div className="mt-4 flex items-center gap-3 rounded-[1rem] border border-slate-800/70 bg-slate-950/20 px-4 py-3">
          <span
            className={[
              ...
              recordingEnabled && hasConsented ? "bg-emerald-400" : "bg-slate-600",
            ].join(" ")}
          />
          <div>
