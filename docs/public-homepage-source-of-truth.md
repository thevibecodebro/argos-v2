...
Keep the strong opener:

> Sales teams changed. Coaching should have too.
...
1. Hero: Sales teams changed. Coaching should have too.
2. Product loop: one real call should create the next useful coaching rep.
3. Command room: calls become coaching evidence, coaching becomes rehearsal.
